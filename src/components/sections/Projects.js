...
import { ExternalLink, Github, Eye, Filter, ChevronDown, Calendar, Code, Monitor } from 'lucide-react';
          ...
          {expandedProject && (
            ...
            >
              <motion.div
                ...
                className="bg-white rounded-2xl w-[80vw] h-[90vh] shadow-2xl border border-gray-100 overflow-hidden flex flex-col"
                onClick={(e) => e.stopPropagation()}
              >
                {(() => {
